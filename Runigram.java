...
public class Runigram {
	...
	public static Color blend(Color c1, Color c2, double alpha) {
		double red =  alpha *(double)c1.getRed() + (1-alpha) * (double)c2.getRed();
		double green =  alpha *(double)c1.getGreen() + (1-alpha) * (double)c2.getGreen();
		double blue =  alpha *(double)c1.getBlue() + (1-alpha) * (double)c2.getBlue();
